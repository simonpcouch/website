...
image:
  ...
  focal_point: ''
  preview_only: yes
summary: "Writing iterative code with '+' using rather than '%>%' was a tough transition my first time around. I thought it might be worth sharing some lessons learned about implementing a pipable programming style when extending {ggplot2}."
---
