...
On other systems, you could also use [Ollama](https://ollama.com). Run `ollama pull qwen3:4b-instruct` at the terminal, then set `options(chores.chat = ellmer::chat_ollama(model = "qwen3:4b-instruct"))`.
