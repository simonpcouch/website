...
tags:
  - ai
  - rstats
subtitle: "The newly released mcptools package makes coding assistants better at
...
> This is a [cross-post](https://www.tidyverse.org/blog/2025/07/mcptools-0-1-0/) from tidyverse.org.

I'm stoked to share about the initial release of mcptools, a package implementing the Model Context Protocol (MCP) in R. MCP standardizes how applications provide context to LLMs. When used with R:
