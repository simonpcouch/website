...
<h1 class="title">I appreciate you dropping by.</h1>
  ...
  Most days, I'm working on open source R packages for data analysis, machine learning, and LLM code-assist. I'm also working on a book called [_Efficient Machine Learning with R_](https://emlwr.org). My [GitHub profile](https://github.com/simonpcouch) links out to some of the projects I spend my time with.
